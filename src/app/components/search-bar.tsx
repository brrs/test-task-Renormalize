...
export function SearchBar({ globalFilter, setGlobalFilter, className }: SearchBarProps) {
    return (
        <div className={`relative h-8 ${className}`}>
            <input
                ...
                placeholder="Search..."
                className="text-xs pl-10 pr-4 py-2 border rounded-lg w-full focus:outline-none focus:ring-1
                bg-primary dark:bg-dark-primary 
                text-primary-text dark:text-dark-primary-text
                border-widget-search dark:border-dark-widget-search
                focus:ring-gray-300
                placeholder-widget-search dark:placeholder-dark-widget-search"
            />
            <svg className="absolute left-3 top-1/2 transform -translate-y-1/2
            stroke-widget-search dark:stroke-dark-widget-search" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* <img src="search.svg" alt="" className="absolute left-3 top-1/2 transform -translate-y-1/2
            fill-widget-search dark:fill-dark-widget-search" /> */}
        </div>
